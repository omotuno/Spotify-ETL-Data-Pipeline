...
def lambda_handler(event, context):
    ...
    for data in spotify_data:
        ...
        # Converting the abum_list to dataframe 
        ...
        # Transforming the release date from object to datatime format
        album_df['release_date'] = pd.to_datetime(album_df['release_date'])
        
        # Transforming the song_added date from object to datatime format
    ...
    # Moving the data from raw_data/_to_processed to raw_data/processed        
